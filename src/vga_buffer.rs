...
pub fn _print(args: fmt::Arguments) {
    ...
    //we must disable interrupts while writing to prevent deadlocks
...
mod test {
    ...
    fn build_writer() -> Writer {
        ...
        Writer {
            column_position: 0,
            color_code: ColorCode::new(Color::LightGreen, Color::Pink),
    ...
    fn empty_char() -> ScreenChar {
        ScreenChar {
            ascii_character: b' ',
            color_code: ColorCode::new(Color::LightCyan, Color::DarkGray)
        }
    }
